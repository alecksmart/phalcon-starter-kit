...
use Main\Main\UserRole;
use Main\Main\UserRoleQuery;
...
class UserRoleTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Main.Main.Map.UserRoleTableMap';
     ...
     */
    const OM_CLASS = '\\Main\\Main\\UserRole';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Main.Main.UserRole';
     ...
     */
    const COL_ID = 'user_role.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'user_role.name';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(UserRoleTableMap::COL_ID, UserRoleTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(UserRoleTableMap::COL_ID => 0, UserRoleTableMap::COL_NAME => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Main\\Main\\UserRole');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Main\Main\UserRole) { // it's a model object
